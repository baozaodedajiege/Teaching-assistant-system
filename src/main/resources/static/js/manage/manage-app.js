...
var app = {
    ...
    URL: {
        ...
        addContestQuestionUrl: function () {
            return app.data.contextPath+"/question/api/addContestQuestion";
        },
        deleteContestQuestionUrl: function () {
            return app.data.contextPath+"/question/api/deleteContestQuestion";
        },
        ...
        getOtherQuestionsUrl: function(contestId) {
            return app.data.contextPath+"/question/api/questionList/" + contestId;
        },
        ...
        manageSyllabusUrl: function () {
            return app.data.contextPath + "/manage/syllabus/";
        },
        addSyllabusUrl: function () {
            return app.data.contextPath+"/subject/api/addSyllabus/";
        },
        ...
        manageClassListUrl: function () {
            return app.data.contextPath+"/manage/class/list/"
        },
        addClassUrl: function () {
            return app.data.contextPath+"/class/api/addClass/";
        },
        updateClassUrl: function () {
            return app.data.contextPath+"/class/api/updateClass/"
        },
        deleteClassUrl: function () {
            return app.data.contextPath+"/class/api/deleteClass/";
        },
        saveClassUrl: function () {
            return app.data.contextPath + "/class/api/saveClass";
        },
        classStudentListUrl: function () {
            return app.data.contextPath + "/manage/class/classStudentList/";
        },
        manageQuestionnaireListUrl: function (index) {
            return app.data.contextPath + "/manage/questionnaire/" + index + "/list";
        },
        addQuestionnaireIndexUrl: function () {
            return app.data.contextPath + "/manage/questionnaire/index/add/"
        },
        addQuestionnaireUrl: function () {
            return app.data.contextPath + '/questionnaire/api/addQuestionnaire';
        },
        submitQuestionnaireUrl: function () {
            return app.data.contextPath + '/questionnaire/api/submitQuestionnaire';
        },
        viewQuestionnaireIndexUrl: function () {
            return app.data.contextPath + '/manage/questionnaire/list/';
        },
        viewQuestionnaireReplyUrl:function(index) {
            return app.data.contextPath + '/manage/questionnaireReply/' + index + '/list';
        },
        viewQuestionnaireReplyDetailUrl:function() {
            return app.data.contextPath + '/manage/questionnaireReply/list/';
        },
        deleteQuestionnaireUrl: function () {
            return app.data.contextPath+"/questionnaire/api/deleteQuestionnaire/";
        },
    },
    /**
