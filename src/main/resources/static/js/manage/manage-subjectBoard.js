...
var manageSubjectBoardPage = {
    ...
    classInfoAction: function (index) {
        window.location.href = app.URL.manageClassListUrl() + index;
    },
    syllabusInfoAction: function (index) {
        window.location.href = app.URL.manageSyllabusUrl() + index;
    },
    questionnaireInfoAction: function (index) {
        window.location.href = app.URL.manageQuestionnaireListUrl(index);
    },
