...
var app = {
    ...
    URL: {
        ...
        discussUrl: function () {
            return app.data.contextPath+"/discuss/1";
        },
        ...
        uploadStudentList: function () {
            return app.data.contextPath+'/class/api/addStudentList/';
        },
        syllabusHtmlPath: function () {
            return app.data.contextPath+'/upload/html/';
        }
    },
    simpleInit: function(contextPath) {
