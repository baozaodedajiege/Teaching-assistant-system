...
public interface QuestionMapper {
    ...
    int addContestQuestion(@Param("contestId") int contestId, @Param("questionId") int questionId);

    List<Question> getOtherQuestionsByContestId(@Param("contestId") int contestId);
}
