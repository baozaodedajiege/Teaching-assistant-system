...
//        LOG.info("result = " + result);
        ...
        subject8.setName("JAVA高级技术");
        subject8.setImgUrl("problemset_database.jpg");
        int result = subjectService.addSubject(subject8);
        LOG.info("result = " + result);
    }
    ...
    public void getSubjects() throws Exception {
        Map<String, Object> data = subjectService.getSubjects(10, 2);
    ...
    public void deleteSubjectById() throws Exception{
        boolean result = subjectService.deleteSubjectById(47);
        LOG.info("result = " + result);
    }
